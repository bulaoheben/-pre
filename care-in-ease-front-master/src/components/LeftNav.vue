...
<!--    <el-menu default-active="1-4-1"-->
    <el-menu :default-active="activeIndex"
      ...
      <el-submenu index="2">
        <template #title>
          <i class="el-icon-video-camera" style="color:white"></i>
          <span>监控摄像管理</span>
        </template>
      ...
      <el-menu-item index="/InteractRecords">
        <i class="el-icon-video-camera" style="color:white"></i>
        <template #title>监控事件统计</template>
      </el-menu-item>
<!--      <el-submenu index="3">-->
<!--        <template #title>-->
<!--          <i class="el-icon-data-analysis" style="color:white"></i>-->
<!--          <span>监控事件统计</span>-->
<!--        </template>-->
<!--        <el-menu-item index="/InteractRecords">交互事件</el-menu-item>-->
<!--        <el-menu-item index="/CCTV2">陌生人事件</el-menu-item>-->
<!--        <el-menu-item index="/CCTV3">跌倒事件</el-menu-item>-->
<!--        <el-menu-item index="/CCTV4">入侵事件</el-menu-item>-->
<!--      </el-submenu>-->
      ...
      <el-submenu index="7">
        ...
        <el-menu-item index="/Oldchart">老年人统计分析</el-menu-item>
        <el-menu-item index="/Volunteerchart">义工统计分析</el-menu-item>
        <el-menu-item index="/Wokerchart">工作人员统计分析</el-menu-item>
      </el-submenu>
