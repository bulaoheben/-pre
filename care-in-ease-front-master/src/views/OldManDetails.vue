<template>
  <div id="OldManDetails" >
    <el-main style="padding: 0">
      <el-breadcrumb separator-class="el-icon-arrow-right" style="background: #ded38c">
        <el-breadcrumb-item :to="{path:'/OldManInfo'}" style="padding: 10px 0 2px 10px; font-size: 1.5em;color: black">老人信息列表</el-breadcrumb-item>
        <el-breadcrumb-item  style="padding: 15px 0 2px 0; font-size: 1.1em; color: black">详细信息</el-breadcrumb-item>
      </el-breadcrumb>
