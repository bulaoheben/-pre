  ...
  <div class="box">
    <div class="right">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item  style="padding: 15px 0 2px 0; font-size: 1.1em; color: white">义工报表</el-breadcrumb-item>
      </el-breadcrumb>
      <div class="videos">
        <el-main class="show">
          <div id="echart1" ref="first"></div>
        </el-main>
        <el-aside class="workChart"></el-aside>
      </div>
      <div class="tip">
        <el-footer></el-footer>
      </div>
...
export default {
  ...
  methods: {
    ...
    getData() {
      this.$http.get(this.global.baseURL + '/back/volunteerrecord',{

      }).then(res=>{
        console.log(res)
        if(res.data.data!==''&&res.data.message==='获取记录成功'){
