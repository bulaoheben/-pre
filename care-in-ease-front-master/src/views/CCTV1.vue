  ...
  <div class="box">
    <div class="right">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item  style="padding: 15px 0 2px 0; font-size: 1.1em">交互检测监控</el-breadcrumb-item>
      </el-breadcrumb>
      <div class="videos">
        <el-main class="show">
          <el-row :gutter="20">
          ...
          <!-- <iframe
              id="iframeId"  frameborder="0"  scrolling="auto"> -->
...
export default {
  ...
  methods: {
    selectCamera() {
      // axios.get(this.value + "close")
      this.url = this.value + 'checking_activity'
      if(this.ip!==''){
